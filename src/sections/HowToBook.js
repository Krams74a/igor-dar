...
import bookImg from "../assets/images/how_to_book.jpg";
...
function HowToBook() {
  ...
  return (
    <section id="how-to-book" className="py-5 how-to-book-section">
      <Container>
        <h2 className="mb-5 text-center title how-to-title">Инструкция по записи</h2>
          ...
          <div className="howto-left">
            {steps.map((step, i) => (
              <div className="step-item-glass" key={i}>
                ...
                <div className="step-content-glass text-white">{step}</div>
              </div>
            ))}
          </div>
